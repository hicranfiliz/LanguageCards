...
object LanguageCardsRepo {
    ...
    fun getLanguageCards(): List<LanguageCard> {
        return listOf(
            ...
            LanguageCard("Car", "Araba", R.drawable.car, 1, "I drove my car to the beach on a sunny day."),
            LanguageCard("House", "Ev", R.drawable.house, 1, "They built a new house near the river."),
            LanguageCard("Sun", "Güneş", R.drawable.sun, 1, "The sun was shining brightly in the afternoon sky."),
            LanguageCard("Book", "Kitap", R.drawable.books, 1, "I’m reading an interesting book about history."),
            LanguageCard("Tree", "Ağaç", R.drawable.tree, 1, "The old oak tree in the park provides a lot of shade."),
            LanguageCard("Water", "Su", R.drawable.water, 1, "It is important to drink enough water every day."),

            LanguageCard("Elephant", "Fil", R.drawable.elephant, 2, "The elephant used its trunk to drink water from the pond."),
            LanguageCard("Mountain", "Dağ", R.drawable.mountain, 2, "They climbed the mountain and enjoyed the beautiful view."),
            LanguageCard("River", "Nehir", R.drawable.river, 2," We sat by the river and listened to the sound of the water."),
            LanguageCard("Computer", "Bilgisayar", R.drawable.coding, 2, "I use my computer to work and play games."),
            LanguageCard("Flower", "Çiçek", R.drawable.iris, 2, "She gave me a beautiful flower from her garden."),
            LanguageCard("Forest", "Orman", R.drawable.forest, 2, "The forest was full of tall trees and singing birds."),
            LanguageCard("Phone", "Telefon", R.drawable.smartphone, 2, "I called my friend on the phone to tell her the news."),
            LanguageCard("School", "Okul", R.drawable.school, 2, "The children walked to school together in the morning."),
            LanguageCard("Doctor", "Doktor", R.drawable.doctor, 2, "The doctor told me I need to rest for a few days."),
            LanguageCard("Teacher", "Öğretmen", R.drawable.teacher, 2, "Our teacher gave us a fun assignment to do over the weekend."),
